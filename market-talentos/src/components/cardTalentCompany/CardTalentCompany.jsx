...
import "../../style/styleCardTalentCompany.scss";
              ...
              <div className="talents__container-infoCustom">
                ...
                <div className="talents__container-profile">
                  <p className="talents__profile">
                    ...
                    Illum nostrum dolores quasi beatae. Placeat quod quia quidem
                    quasi accusamus maxime nemo ut, alias ullam, exercitationem
                    deleniti ad vero totam vitae.
                  </p>
                </div>
              </div>
...
export default CardTalentCompany;
