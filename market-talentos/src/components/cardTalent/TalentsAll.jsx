                ...
                <div className="talentsAll__container-info">
                  <div className="talentsAll__container-state">
                    ...
                    <div className="talentsAll__container-levelEnglish">
                        ...
                        <div className="talentsAll__container-programs">
                          <span className="talentsAll__programs">JAVA-SCRIPT</span>
                          <span className="talentsAll__programs">REACT</span>
                  ...
                  <div className="talentsAll__container-infoPnal">
                    <span className="talentsAll__name">
                      <strong>{talent.firstName}</strong>
                    </span>
                    <span className="talentsAll__lastName">
